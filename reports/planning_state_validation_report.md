...
| planned_slots_have_impact_buckets | ERROR | PASS | well-impact rows=5; buckets=['BROAD', 'SINGLE_WELL_DOMINATED', 'SPARSE_INFORMATION'] |
| planned_slots_have_diversity_flags | ERROR | PASS | diversity rows=5; flags=['OK', 'REDUNDANT_REVIEW'] |
| planned_slots_have_slot_reviews | ERROR | PASS | slot-review rows=5; reviews=['BUILD_NEW_ARCHITECTURE_FIRST'] |
...
| replacement_queue_has_build_or_review_paths | INFO | PASS | build/review task rows=3 |
