...
| RCQ02_dedupe_backup_sp45_projection | 100 | existing_candidate_review | REVIEW_EXISTING | Q20260629-B02, Q20260629-B06, Q20260629-B12, Q20260629-B13 | S03_baseline_valid_fleongg_weak; S07_gates_clear_but_redundancy_unresolved | projection_branch | artifacts/fleongg_branch_calibration_joezzzzz_v1/sp45_projection_submission.csv | Promote at most one representative if audit passes and it is not a duplicate of an already planned SP45 output. | Uses existing audited projection signal without adding another nearby blend weight. | unknown_possible_but_risky; backup projection paths appear duplicate with each other |
...
| RCQ02_dedupe_backup_sp45_projection |  | python3 scripts/pre_submit_audit.py artifacts/fleongg_branch_calibration_joezzzzz_v1/sp45_projection_submission.csv --data-dir data/sample --reference-registry experiments/reference_submission_registry.csv |
