...
| --- | --- | --- | --- | --- | --- | --- | --- |
| artifacts/gr_typewell_light_alpha040_v1/submission.csv | gr_typewell_light | READY_AFTER_AUDIT_REVIEW | plausible_7p2_to_7p8_band | 1.39813 | conservative_low_upside_backup | 33 | Safe-ish low-upside backup; use only if more informative slots are unavailable. |
...
| artifacts/fleongg_branch_calibration_joezzzzz_v1/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | unknown_possible_but_risky | 5.79449 | manual_review | 20 | Needs manual review before replacing a planned slot. |
| artifacts/fleongg_branch_calibration_joezzzzz_v2/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | unknown_possible_but_risky | 5.79449 | manual_review | 20 | Needs manual review before replacing a planned slot. |
| artifacts/lucifer_baseline_repro_joezzzzz_v1/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | unknown_possible_but_risky | 5.79449 | manual_review | 20 | Needs manual review before replacing a planned slot. |
