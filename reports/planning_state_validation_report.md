...
| input_replacement_candidate_queue_exists | ERROR | PASS | replacement candidate queue CSV is readable |
...
| external_context_blocks_release | ERROR | PASS | pending=1; running=0; batch_status=WAIT_EXTERNAL_CONTEXT; gates=['BLOCKED_EXTERNAL_CONTEXT'] |
...
| planned_slots_have_impact_buckets | ERROR | PASS | well-impact rows=5; buckets=['BROAD', 'CONCENTRATED', 'SINGLE_WELL_DOMINATED'] |
...
| replacement_queue_has_core_tasks | ERROR | PASS | replacement queue tasks=['RCQ01_replacement_need_guard', 'RCQ02_dedupe_backup_sp45_projection', 'RCQ03_build_gr_typewell_alpha040', 'RCQ04_build_gr_typewell_relaxed_alpha030', 'RCQ05_build_plateau_nondefault_variant', 'RCQ06_design_sp45_plateau_gate', 'RCQ07_audit_degnonguidi_if_complete'] |
| replacement_need_has_actionable_queue | ERROR | PASS | replacement_need=2; actionable_tasks=5 |
| replacement_queue_has_build_or_review_paths | INFO | PASS | build/review task rows=4 |
...
| pending_context_has_result_application_blockers | ERROR | PASS | blocking result-application rows=1 |
