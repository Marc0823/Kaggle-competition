...
| running_kernels | 0 |
| readiness_status_counts | READY_AFTER_AUDIT_REVIEW=10; HOLD_DUPLICATE=6; HOLD_PENDING_ANCHOR=4; HOLD_LOW_UPSIDE=2; HOLD_INFORMATION_SLOT=1 |
| audit_gate_counts | AUDIT_PASS_WARN_REVIEW=20; AUDIT_PASS=3 |
| submission_gate_counts | READY_REVIEW_WARNINGS=10; HOLD_DUPLICATE=6; HOLD_PENDING_ANCHOR=4; HOLD_LOW_UPSIDE=2; HOLD_INFORMATION_SLOT=1 |
| batch_status | READY_FOR_RELEASE_REVIEW |
| planned_slots | 5 |
| current_action_counts | final_review_before_submit=5 |
...
| replacement_pool_role_counts | do_not_use_duplicate=6; manual_review=5; already_planned=5; pending_equivalent_not_replacement=4; conservative_low_upside_backup=3 |
| replacement_queue_status_counts | TODO_BUILD=2; ACTIVE=1; NO_CANDIDATE=1; ARTIFACT_AND_AUDIT_EXIST=1; DESIGN_REQUIRED=1; WAIT_KERNEL=1 |
| replacement_queue_ready_now_counts | False=4; True=3 |
| artifact_manifest_gate_counts | PASS_SOURCE_POINTER=5 |
| release_gate_counts | MANUAL_REVIEW_REQUIRED=5 |
| final_package_gate_counts | REVIEW_READY_TO_PACKAGE=5 |
| result_branch_rules | 7 |
| result_application_status_counts | ACTION_READY=4; PASS=1 |
