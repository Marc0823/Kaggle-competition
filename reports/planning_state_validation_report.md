...
| external_context_blocks_release | ERROR | PASS | pending=0; running=1; batch_status=WAIT_EXTERNAL_CONTEXT; gates=['BLOCKED_EXTERNAL_CONTEXT'] |
...
| pending_context_has_result_application_blockers | ERROR | PASS | blocking result-application rows=2 |
