...
- Ready-after-audit candidates with no context blocker: `10`
...
| artifacts/gr_typewell_light_alpha040_v1/submission.csv | gr_typewell_light | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 1.39813 | 0.0360878 | 7.06814e-05 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 1.45864 | 6.39778 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/submission_sp45_fleongg_w0.60.csv | projection_learned_blend | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 2.15794 | 3.85775 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/submission_sp45_fleongg_w0.58.csv | projection_learned_blend | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 2.20956 | 3.73075 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/submission_sp45_fleongg_w0.55.csv | projection_learned_blend | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 2.28867 | 3.54025 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/submission_sp45_fleongg_w0.52.csv | projection_learned_blend | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 2.36963 | 3.34974 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/kernel_outputs/rogii-baidalin-7-201-preflight-codex_v1/submission_sp45_fleongg_w0.50.csv | projection_learned_blend | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | plausible_7p2_to_7p8_band | 2.42452 | 3.22274 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/fleongg_branch_calibration_joezzzzz_v1/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | unknown_possible_but_risky | 5.79449 | 2.65079 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/fleongg_branch_calibration_joezzzzz_v2/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | unknown_possible_but_risky | 5.79449 | 2.65079 | 0 | Eligible only after source/output audit and batch diversity review. |
| artifacts/lucifer_baseline_repro_joezzzzz_v1/sp45_projection_submission.csv | projection_branch | READY_AFTER_AUDIT_REVIEW | LOCAL_CANDIDATE | unknown_possible_but_risky | 5.79449 | 2.65079 | 0 | Eligible only after source/output audit and batch diversity review. |
...
One or more candidates are ready for final source/output audit review before a planned official slot.
